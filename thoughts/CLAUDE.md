...
This directory contains developer thoughts and notes for the deft-indexer repository.
It is managed by the HumanLayer thoughts system and should not be committed to the code repository.

## Structure

- `adrifadilah/` → Your personal notes for this repository (symlink to ~/thoughts/repos/deft-indexer/adrifadilah)
- `shared/` → Team-shared notes for this repository (symlink to ~/thoughts/repos/deft-indexer/shared)
- `global/` → Cross-repository thoughts (symlink to ~/thoughts/global)
  - `adrifadilah/` - Your personal notes that apply across all repositories
